...
public class InstructorCourseEditPageE2ETest extends BaseE2ETestCase {
        ...
        public void testAll() {
                ...
                editPage.verifyStatusMessage(
                                "The instructor " + newInstructor.getName() + " has been added successfully. "
                ...
                List<InstructorAttributes> instructorsToCopy = List.of(instructorToCopy1, instructorToCopy2,
                                instructorToCopy3);
